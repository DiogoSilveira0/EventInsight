        ...
        for signal in range(lim):
            ...
            try:
                message = json.dumps({
                        ...
                        "fields": {
                            "people_waiting" : 0 if ctl % 3 == 2 and signal == lim - 1 else (30 + random.randint(-5, 5)),  ### dados simulados
                            "avg_time" : 0.0 if ctl % 3 == 2 and signal == lim - 1 else (10.5 + random.randint(-5, 5))
                        }
                    })
